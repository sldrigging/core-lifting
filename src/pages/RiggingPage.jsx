  ...
  return (
    <>
      ...
      <section id="locations" className="rp-section">
        ...
        <div>
          <iframe width="640px" height="480px" src="https://forms.office.com/r/wssL87gKyR?embed=true" frameborder="0" marginwidth="0" marginheight="0" style="border: none; max-width:100%; max-height:100vh" allowfullscreen webkitallowfullscreen mozallowfullscreen msallowfullscreen> </iframe>
        </div>
      </section>
    </>
  );
